...
class StripeWH_Handler:
    ...
    Some content from the Boutique Ado project
    """
    ...
    def _send_confirmation_email(self, order):
        ...
        subject = render_to_string(
            'checkout/confirmation_emails/confirmation_email_subject_line.txt',
            {'order': order})
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # In the shipping details replace empty strings with none
        for field, value in shipping_details.address.items():
            if value == "":
                shipping_details.address[field] = None

        # If save_info was checked update the profile details
        # First line allows anonymous users to check out 
        profile = None
